...
export function criarNovoGoblin(): Monstro {
  ...
  const novoGoblin = new Monstro(nome, 7, 7, atributos, Equipamentos.adaga, Equipamentos.couro, Equipamentos.vazioArma);
...
export function criarNovoDragaoVermelhoAdulto(): Monstro {
  ...
  const novoDragaoVermelhoAdulto = new Monstro(nome, 256, 256, atributos, mordida, escamasDragaoVermelho, Equipamentos.vazioArma, soproFogo);
