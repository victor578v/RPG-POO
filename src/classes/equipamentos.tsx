...
export const shoushaBlade = new Arma("Odachi de Amaterasu", "Uma imponente odachi imbuida com energia da deusa do sol Amaterasu.", 2, 6, TipoDano.Cortante, [duasMaos, danoExtra], 2, 6, TipoDano.Radiante); // Odachi de Amaterasu, 2d6 dano, Propriedades: Duas Mãos, Dano Extra (Radiante)
...
export const placas = new Armadura("Placas", "Uma armadura de placas de metal completa. Proteção Pesada.", "pesada", 10); // Armadura de Placas, Pesada, CA 20
...
export const studded = new Armadura("Couro Batido", "Uma armadura de couro com reforços de metal.", "leve", 3); // Armadura de Couro Batido, Leve, CA 13 + Des
export const couro = new Armadura("Couro", "Uma armadura básica feita de couro.", "leve", 1); // Armadura de Couro, Leve, CA 11 + Des
