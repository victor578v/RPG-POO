...
export class Arma extends Item {
  ...
  public tipoDanoExtra?: TipoDano; // Tipo de dano Extra que a arma causa
...
export const broken = new Armadura("Armadura quebrada", "Uma armadura quebrada de um antigo soldado.", "media", 2); // Armadura de Couro, Leve, CA 11 + Des
